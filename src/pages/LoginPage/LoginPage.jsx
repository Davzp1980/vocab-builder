  ...
  return (
    <div className={clsx(css.mainRegisterContainer)}>
      ...
      <div className={css.registerFormContainer}>
        ...
        <p className={css.textUnderPhoto}>
          Word · Translation · Grammar · Progress
        </p>

        <div className={css.registerFormDiv}>
          <h1 className={css.formH1}>Login</h1>
          <p className={css.formText}>
            Please enter your login details to continue using our service:
          </p>

          <form className={css.form} onSubmit={handleSubmit(submitLoginForm)}>
          ...
          <Link className={css.linkLogin} to="/register">
            Register
          </Link>
        </div>
      </div>
